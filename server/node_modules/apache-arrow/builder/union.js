...
class UnionBuilder extends builder_js_1.Builder {
    ...
    _valueToChildTypeId(builder, value, offset) {
        throw new Error(`Cannot map UnionBuilder value to child typeId. Pass the childTypeId as the second argument to unionBuilder.append()`);`)
throw new Error(`Pass the childTypeId as the second argument to unionBuilder.append()`
